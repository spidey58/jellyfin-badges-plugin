...
Called from the GitHub Actions workflow - not meant to be run manually,
though it's safe to do so for testing.
"""
import argparse
import json
import os
...
def main():
    ...
    parser.add_argument("--repo", required=True, help="e.g. spidey58/jellyfin-badges-plugin")
